    ...
    <footer className="border-t border-white/5 py-12 px-6 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-white/20 text-[10px] uppercase tracking-[0.3em]">Premium Digital Art Community</p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          <div className="mb-4">
            <a 
              ...
              className="bg-[#5865F2] hover:bg-[#4752C4] text-white px-4 py-2 rounded-lg text-xs font-bold transition-colors flex items-center gap-2"
            >
              <span>العميل المميز</span>
